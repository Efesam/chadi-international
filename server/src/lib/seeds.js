...
export function seedPrograms() {
  return [
    ...
    { id: "program_sorcest", slug: "sovcest", title: "SOVCEST", category: "Education", tagline: "From Forgotten to Empowered", description: "Providing education, mentorship and digital skills for vulnerable children and youth.", icon: "🎓" },
