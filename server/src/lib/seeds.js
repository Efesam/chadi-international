...
export function seedProjects() {
  return [
    ...
    { id: "project_sorcest", slug: "sorcest-tech", title: "Digital Skills for Orphans", image: "/uploads/projects/sorcest.jpg", program: "SORCEST", location: "Bauchi State", status: "Ongoing", featured: true, summary: "Providing technology education, mentorship and digital skills training for orphaned children.", beneficiaries: "150 Students" },
